...
from extern.MVC.mvc.ldm.util import instantiate_from_config


PRETRAINED_MODELS = {
    "mvc-diffusion": {
        "config": "mvc.yaml",
        "repo_id": "yyyfan/magic-boost",
        "filename": "magic-boost-4view.pt",
    },
}
...
def get_config_file(config_path):
    cfg_file = pkg_resources.resource_filename(
        "mvc-diffusion", os.path.join("configs", config_path)
    )
